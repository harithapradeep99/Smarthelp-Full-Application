...
export const ProfileUpdateImpl = () => {
  ...
  React.useEffect(() => {
    const getDataFromDBAdmin = async () => {
      const result = await getAdminUser(dispatch, currentUser._id, currentUser.username);
      if (result) {
      ...
      <div className="productTop">
        ...
        <div className="productTopRight">
          <div className="productInfoTop">
            <img src={PF+currentUser.profilePicture} alt="" className="productInfoImg" />
          ...
          <div className="productInfoBottom">
            ...
            <div className="productInfoItem">
              ...
              <span className="productInfoValue">{currentUser.fname}</span>
            </div>
            <div className="productInfoItem">
              <span className="productInfoKey">Last Name:</span>
              <span className="productInfoValue">{currentUser.lname}</span>
            </div>
            <div className="productInfoItem">
