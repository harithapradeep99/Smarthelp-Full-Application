...
import { Footer, Subheader_X, ProjectBox } from '../../../../components';
...
const Allprojects = () => {
    ...
    useEffect(() => {
        axios
            .get("/api/projects")
            .then(res => {
                console.log(res.data.existingprojects)
                setProjects(res.data.existingprojects);
            })
            .catch(err => {
                console.log(err);
            })
    ...
    const handleSearchArea = (e) => {
        axios.get("/api/projects").then((res) => {
            if (res.data.success) {
                filterData(res.data.existingprojects, searchKey);
            }
        });
    }
        ...
        <div>
            ...
            <section className="csr_col">
                ...
                <div className="project_types">
                    <ul>
                        <li><Link to="/csr/ongoing_projects/all">All</Link></li>
                        <li><Link to="/csr/ongoing_projects/urgent">Urgent Fundraising</Link></li>
                        <li><Link to="/csr/ongoing_projects/medical">Medical Assistance</Link></li>
                        <li><Link to="/csr/ongoing_projects/shelter">Shelter Arrangement</Link></li>
                        <li><Link to="/csr/ongoing_projects/items">Essential Item Contribution</Link></li>
                    </ul>
                </div>
                <div className="csr_body">
                    ...
                    <div className="search">
                        ...
                        <button onClick={handleSearchArea} type='submit'>Search</button>
                    </div>
                            ...
                            <div className="project-box">
                                ...
                                <div className="project-box-right">
                                    <div className='pbr-col-1'>
                                        ...
                                        <div className='read'>
                                            <Link to={`/csr/ongoing_projects/projects/${Project._id}`}>
                                    ...
                                    <div className='pbr-col-3'>
                                        ...
                                        <div className='pbr-col-3-row-2'>
                                            <Link to={`/csr/ongoing_projects/projects/${Project._id}/donate`}>
